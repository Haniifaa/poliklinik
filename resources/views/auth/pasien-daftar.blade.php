...
@endif
    ...
    <section class="relative z-10 w-full max-w-sm bg-white bg-opacity-20 rounded-lg shadow-lg p-4 backdrop-blur-sm">
        ...
        <!-- Form -->
        <form class="space-y-3" action="{{ route('pasien.register') }}" method="POST">
            @csrf
            <div>
            ...
            <p class="text-xs text-gray-500 text-center">
                Sudah punya akun? <a href="{{ route('login.pasien') }}" class="font-medium text-purple-600 hover:underline">Masuk di sini</a>
            </p>
        </form>
    </section>
</body>
