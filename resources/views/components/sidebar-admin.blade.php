...
<div class="h-full px-3 pb-4 overflow-y-auto bg-white">
    <ul class="space-y-2 font-medium">
        <li>
            <a href="{{ route('admin.dashboard') }}" class="flex items-center p-2 text-purple-800 rounded-lg hover:bg-gray-100">
        ...
        <li>
            <button
                ...
                <!-- Ikon Master Data -->
                <svg class="flex-shrink-0 w-5 h-5 text-purple-800 transition duration-75 group-hover:text-gray-900" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                <li>
                    <a href="{{ route('admin.masterdata.pasien') }}" class="flex items-center w-full p-2 text-purple-800 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Pasien</a>
                </li>
                <li>
                    <a href="{{ route('admin.masterdata.dokter') }}" class="flex items-center w-full p-2 text-purple-800 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Dokter</a>
                </li>
                <li>
                    <a href="{{ route('admin.masterdata.obat') }}" class="flex items-center w-full p-2 text-purple-800 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Obat</a>
                </li>
                <li>
                    <a href="{{ route('admin.masterdata.poli') }}" class="flex items-center w-full p-2 text-purple-800 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Poli</a>
                </li>
            </ul>
        </li>
