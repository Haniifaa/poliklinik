...
<div class="h-full px-3 pb-4 overflow-y-auto bg-white">
    <ul class="space-y-2 font-medium">
        <li>
            <a href="{{ route('pasien.dashboard') }}" class="flex items-center p-2 text-purple-800 rounded-lg hover:bg-gray-100">
        ...
        <li>
            <a href="{{ route('pasien.poli') }}" class="flex items-center p-2 text-purple-800 rounded-lg hover:bg-gray-100">
