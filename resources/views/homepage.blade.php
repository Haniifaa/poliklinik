...
<body class="relative bg-gradient-to-r from-[#F3F4FE] via-[#EBF4FF] to-[#E8F7FF] min-h-screen overflow-hidden flex items-center justify-center">
    ...
    <div class="absolute inset-0">
        ...
        <div class="absolute -top-2 right-1 w-60 h-60 bg-purple-600 rounded-full blur-xl opacity-15"></div>
    </div>

    <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" id="online-doctor-appointment" x="0" y="0" style="enable-background:new 0 0 3800 3000" version="1.1" viewBox="0 0 3800 3000" class="w-full h-auto max-w-full">
        <g>
          <g>
    ...
    <div class="relative z-10 text-center text-gray-800 px-4">
        <div class="text-center">
            <h1 class="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-pink-400 to-purple-500 text-transparent bg-clip-text" style="line-height: 1.2;">
                Selamat Datang
            </h1>
            <h3 class="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-purple-500 to-indigo-600 text-transparent bg-clip-text" style="line-height: 1.2;">
                di Sistem Temu Janji Poliklinik
            </h3>
        </div>

        <p class="text-sm md:text-base mb-8">Silakan pilih login sebagai pasien atau dokter untuk melanjutkan.</p>

        <div class="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-6">
            <!-- Card Pasien -->
            <a href="{{ route('daftar.pasien') }}" class="w-full md:w-64 h-48 bg-white/30 backdrop-blur-lg rounded-lg shadow-lg flex flex-col items-center justify-center p-4 hover:bg-white/50 transition">
                <h2 class="text-2xl font-semibold text-gray-800 mb-2">Login Pasien</h2>
                <p class="text-sm text-gray-600">Masuk sebagai pasien untuk mengakses layanan kami.</p>
            </a>
            <!-- Card Dokter -->
            <a href="{{ route('login.dokter') }}" class="w-full md:w-64 h-48 bg-white/30 backdrop-blur-lg rounded-lg shadow-lg flex flex-col items-center justify-center p-4 hover:bg-white/50 transition">
                <h2 class="text-2xl font-semibold text-gray-800 mb-2">Login Dokter</h2>
                <p class="text-sm text-gray-600">Masuk sebagai dokter untuk mengelola data pasien.</p>
            </a>
        </div>
    </div>
</body>
